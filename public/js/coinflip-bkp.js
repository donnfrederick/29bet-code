    ...
    "1Vy0": function(e, i) {
        $.on("/coinflip", function() {
            ...
            betAudio = new Audio, swooshAudio = new Audio, winAudio = new Audio, loseAudio = new Audio, window.coinflip = function() {
                            ...
                            if (xhr.status >= 200 && xhr.status < 300) {
                                ...
                                if (response.status === 200) {
                                    ...
                                    null == e && !0 !== i && $.get("/game/coinflip/" + $("#bet").val(), function(i) {
                                        ...
                                        betAudio.src = isAudioGame ? "/assets/media/bet.mp3" : "", isSoundOn ? betAudio.play() : null, $(".outcome-window").fadeOut("fast"), $(".outcome-window-lose").fadeOut("fast"), $(".coin").toggleClass("game-disabled", !1).fadeIn("fast"), $("#play").attr("disabled", true).attr("onclick", "take()"), clearInterval(clI), clearInterval(cli), updateBalanceN(), e = o, flip(cor), _disableDemo = !0
                                    });
                                } else {
                                    b = 0;
                                    b2 = 0;
                    ...
                    null != e && !0 !== i && $.get("/game/coinflip/flip/" + e.id + "/" + s, function(s) {
                        ...
                        i = !0, $("#coin").attr("class", ""), setTimeout(function() {
                            ...
                            setTimeout(function() {
                                ...
                                if (i = !1, "lose" === t.status) cor = null, $('#play').attr('disabled', true), uapts(0), 0 == t.demo && ($('.outcome-window-lose').fadeIn(200), cli = setInterval(() => {$('.outcome-window-lose').fadeOut(200);clearInterval(cli)}, 3000)), 1 == t.demo && ($('.outcome-window-lose').fadeIn(200), cli = setInterval(() => {$('.outcome-window-lose').fadeOut(200);clearInterval(cli)}, 3000)),
                ...
                winAudio.src = isAudioGame ? "/assets/media/win.mp3" : "", isSoundOn ? winAudio.play() : null, isDemo || sendDrop(e.id), validateTask(e.id), isDemo && isGuest() && showDemoTooltip(), clear(), updateBalanceN(), parseFloat(o.profit) > 0 && $('.outcome-window_won__sum').text(o.profit), $('.outcome-window').fadeIn(200), clI = setInterval(() => {$('.outcome-window').fadeOut(200);clearInterval(clI)}, 3000);
