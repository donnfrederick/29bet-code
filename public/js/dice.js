        ...
        $.on("/dice", function() {
            ...
            (e = $("#slider-range").slider({
                ...
                if (parseFloat($('#bet_profit').html()) <= 0) {
                    ...
                    rollAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/assets/media/roll.mp3" : "", isSoundOn ? rollAudio.play() : null;
                    ...
                    $("#circle").fadeIn("fast"), $("#circle").css({
                        ...
                        0 == r && (loseAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/assets/media/lose.mp3" : "", isSoundOn ? loseAudio.play() : null);
                        if (!0 == r && winMulti > !1) {
                            winMulti = winMulti - 1
                        }
                        ...
                        if (xhr.status >= 200 && xhr.status < 300) {
                            ...
                            if (response.status === 200) {
                                ...
                                let delay = setInterval(function() {
                                    ...
                                    winAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/assets/media/win.mp3" : "";
                                    if (isSoundOn) {
                                        winAudio.play()
                                    }
