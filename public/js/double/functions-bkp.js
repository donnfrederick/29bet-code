//  (function(){
    newWheel = {
        ...
        eq: {
            0:'black', 1:'red', 2:'black', 3:'red', 4:'black', 5:'red', 6:'black', 7:'red', 8:'black', 9:'red', 10:'black',
            11:'red', 12:'black', 13:'red', 14:'black', 15:'red', 16:'black', 17:'red', 18:'black', 19:'red', 20: 'white'
        },
        prizesColors: [],
        hasWhite: false,
        resultados: [],
        ...
        criaCards: function() {
            var arrayProbab     = {'white':[],'red':[],'black':[]};
            $('.roulette-wheel').html('');
        ...
        cronometro: function (segundos, callback) {
            ...
            if (newWheel.rdd != 0) {
                ...
                let delay = setInterval(() => {
                    ...
                    if(typeof(newWheel.interval)=='number'){ clearInterval(newWheel.interval);}
                    $('#timer_init').animate({
                        width: 0 + 'px'
                    }, segundos * 1000);
            ...
            xhr.onload = () => {
                if (xhr.status >= 200 && xhr.status < 300) {
                    ...
                    if (response.status === 200) {
                        ...
                        newWheel.roulette.rotateTo(newWheel.itemRoulette, { tracks: trackSpeed, random: true });
