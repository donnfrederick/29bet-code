$.on("/plinko", function () {
    ...
    window.setMode = function (t, e) {
        ...
        window.initPlinko = function (e) {
            ...
            const Canvas_canvas = document.querySelector('canvas');
            Canvas_canvas.style.paddingTop = '30px';
            c = function (e) {
                    n.clear(b.world), g = [];

                    // const i = (e - 3) / ((e - 7) / 2) * (800 / 700);

                    const a = e + 2,
                        // i = 0.2 * Math.min(Nw, Nh);
                        o = 800 / a / 2,
                        i = (e - 3) / ((e - 7) / 2) * (800 / 700),
                        ...
                        h = 560 / e,
                        _ = Array(e).fill().map((_, rowIndex) => {
                            const pegImage = 'https://cdn.29bet.com/assets/img/plinko/planets/p7.webp';

                            // Load the image to get its dimensions
                            const img = new Image();
                            img.src = pegImage;

                            // Set default dimensions in case image loading fails
                            let imgWidth = 0.65;
                            let imgHeight = 0.65;

                            // Adjust dimensions once the image is loaded
                            img.onload = () => {
                                imgWidth = img.width;
                                imgHeight = img.height;
                            };
                            const pegWidth = imgWidth / t;
                            const pegHeight = imgHeight / t;

                            const yOffset = y * (e - rowIndex - 1) / 2;
                            // console.log(o, y, e, yOffset, h, rowIndex);
                            return Array(rowIndex + 3).fill().map((_, e) =>
                                ((x, y) => s.circle(x, y, i, {
                                    isStatic: true,
                                    restitution: 0.8,
                                    render: {
                                    ...
                                    label: "peg"
                                }))(o + y * e + y / 2 + yOffset, h * rowIndex + h / 2))
                        }).reduce((t, e) => [...t, ...e], []),

                        // original peg section
                        // y = (800 - 2 * o) / a,
                        // h = 560 / e,
                        // _ = Array(e).fill().map((t, a) => {

                        //     const n = y * (e - a - 1) / 2;
                        //     return Array(a + 3).fill().map((t, e) =>
                        //     ((t, e) => s.circle(t, e, i, {
                        //         isStatic: !0,
                        //         render: {
                        //             fillStyle: "#D4AF37"
                    ...
                    // try and error if image is not avaiable
                    n.add(r, [...k, ..._, ...A]), d = function (y, e, a, o, l) {
                        // Assets for balls {images}
                        // Maximum 5 images for now, add more if needed
                        const litratongbola = [
                            'https://cdn.29bet.com/assets/img/plinko/planets/p1.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p3.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p5.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p7.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p-7.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p-1.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p-3.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p-6.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p-4.webp',
                            'https://cdn.29bet.com/assets/img/plinko/planets/p-10.webp'
                        ];

                        litratongbola.forEach(item => {
                            item.scale = 0.5;
                        });


                        // Ball dimensions
                        const ballWidth = 0.8 / t;
                        const ballHeight = 0.8 / t;

                        const createPlinkoCircle = (y, e, a, o, n) => {
                            const radius = 1.1 * i;
                            const xPosition = 400 + y;

                            // Randomly choose between using an image or a random color
                            const useImage = Math.random() < 0.5; // 50% chance of using image
                            let options;

                            if (useImage && litratongbola.length > 0) {
                                // Randomly choose an image from the array
                                const randomImage = litratongbola[Math.floor(Math.random() * litratongbola.length)];
                                options = {
                                    restitution: .8,
                                    label: "plinko-" + e,
                                    render: {
                            ...
                            // Create the circle with the specified options
                            const circle = s.circle(xPosition, 0, radius, options);
                            p[e] = a;
                            m[e] = o;
                            f[e] = n;
                        ...
                        const plinkoCircle = createPlinkoCircle(y, e, a, o, l);
                        n.add(r, plinkoCircle);
                    ...
                    // hybrid outout
                    // n.add(r, [...k, ..._, ...A]), d = function (y, e, a, o, l) {
                    //     // assets sa bola {images}
                    //     // hangang 5 lng max na assets wag na dagdagan magpalit lng if need
                    //     const litratongbola = [
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p1.webp',
                    //         // 'https://cdn.29bet.com/assets/img/plinko/planets/p2.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p3.webp',
                    //         // 'https://cdn.29bet.com/assets/img/plinko/planets/p4.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p5.webp',
                    //         // 'https://cdn.29bet.com/assets/img/plinko/planets/p6.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p7.webp',
                    //         // 'https://cdn.29bet.com/assets/img/plinko/planets/p8.webp',
                    //         // 'https://cdn.29bet.com/assets/img/plinko/planets/p9.webp',
                    //         // 'https://cdn.29bet.com/assets/img/plinko/planets/p10.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p-7.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p-1.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p-3.webp',
                    //         'https://cdn.29bet.com/assets/img/plinko/planets/p-6.webp',
                    ...
                    //     ];
                    //     // Sukatngballs
                    //     const widthngballs = 1 / t;
                    //     const heightngballs = 1 / t;
                    ...
                    //         // Create the circle with the specified options
                    //         const circle = s.circle(l, 0, r, options);
                    //         p[e] = a;
                    //         m[e] = o;
                    //         f[e] = n;
                    ...
                    //         // pang options sa bola
                    //         const circleOptions = {
                    //             restitution: .8,
                    //             label: "plinko-" + e,
                    //         };

                    //         // Check if random color is generated
                    //         if (randomColor) {
                    //             // Attributes pang Sprites
                    //             circleOptions.render = {
                    //                 fillStyle: randomColor,
                    //             };
                    //         }

                    //         // Create the circle with the specified options
                    //         const circle = s.circle(l, 0, r, circleOptions);
                    //         p[e] = a;
                    //         m[e] = o;
                    //         f[e] = n;
                    ...
                    //     const createPlinkoCircle = (y, e, a, o, n) => {
                    //         // console.log(widthngballs, heightngballs, t);
                    //         const r = 1.1 * i;
                    //         const l = 400 + y;
                    //         // console.log(i);

                    //         const ballColor = litratongbola[Math.floor(Math.random() * litratongbola.length)];
                ...
                $.get("/game/plinko/multipliers", function (t) {
                    ...
                    e.forEach(t => {
                        ...
                        if (o.includes("plinko") && s.includes("plinko") && (t.isActive = !1), s.includes("plinko") && o.includes("bucket")) {
                            ...
                            // TODO gawan ng trigger event para sa highest multiplier for confetti
                            if (bucketNumber === '9') {
                                console.log("The ball hit the jackpot bucket (w[9])!");
        ...
        window.plinko = function () {
                    ...
                    xhr.onload = () => {
                        if (xhr.status >= 200 && xhr.status < 300) {
                            ...
                            if (response.status === 200) {
                                ...
                                // document.querySelector('.blip-container').classList.add('blip_bounce');
            ...
            if (null != a.error) return "$" === a.error && load("games"), -1 === a.error && $("#b_si").click(), 0 === a.error && iziToast.error({
                ...
                void w--;
            betAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/media/bet.mp3" : "", isSoundOn ? betAudio.play() : null,
                $(".outcome-window").fadeOut(200), clearInterval(cli), setTimeout(function () {
                    e = !1
                }, 10), drop(a.bucket, a.id, a.profit.toFixed(2), a.multiplier, a.demo)
        }, window.execTake = function (t, e) {
            $(".outcome-window__coeff-demo").text("x" + t),
                $(".outcome-window_won__sum").text(e),
                $(".outcome-window").fadeIn(200), cli = setInterval(() => {
                    $(".outcome-window").fadeOut(200);
                    clearInterval(cli)
                }, 1000),
                // $(".congrats").fadeOut(200);clearInterval(cli)}, 1000),
                winAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/media/win.mp3" : "", isSoundOn ? winAudio.play() : null
            $('.btn_outcome').click();
        },
        // $('.btn_outcome').click();
        ...
        // const blip = document.querySelector('maabong_planeta');
        // blip.classList.add('blip_animation');
        //
        window.drop = function (e, a, o, i, n) {
            setTimeout(() => {
                // document.querySelector('.blip-container').classList.remove('blip_bounce');
            }, 2000);
...
$('.linksidebar').click(function () {
    ...
    let xlose = setInterval(() => {
        if ($(".plinko canvas").length >= 2) {
            $(".plinko canvas:last").css('display', 'none');
            clearInterval(xlose);
        }
    });
});
