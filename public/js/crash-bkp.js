        ...
        $.on("/crash", function() {
            ...
            betAudio = new Audio, winAudio = new Audio, loseAudio = new Audio, window.init = function() {
                ...
                if (!1 !== s) return iziToast.info({
                    message: "Você aposta com muita frequência!",
                    icon: "fa fa-info"
                }), setTimeout(function() {
                    s = !1
                }, 10);
                s = !0, null != a ? (t = -1, $.get("/game/crash/take/" + a + (isDemo ? "?demo" : ""), function(t) {
                    var o = JSON.parse(t);
                    if (null == o.error) {
                        1 == o.demo && ($(".c_f").toggleClass("c_f-progress-demo", !1), $(".c_f").toggleClass("c_f-win-demo", !0)), 0 == o.demo && ($(".c_f").toggleClass("c_f-progress", !1), $(".c_f").removeClass("c_f-win-demo", !1), $(".c_f").toggleClass("c_f-win", !0)), winAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/assets/media/win.mp3" : "", winAudio.play(), setTimeout(function() {
                            s = !1
                        }, 10);
                        var i = parseFloat(o.profit).toFixed(2);
                        $("#game_profit").html((o.mul >= 1 ? "Você ganhou " : "") + i + ' &nbsp;<i class="fad fa-coins"></i>');
                ...
                null == a ? ($("#play").attr("onclick", "crash()"), setBetText("Jogar")) : $("#play").attr("onclick", "take()")
                            ...
                            $.get("/game/crash/tick/" + a + (isDemo ? "?demo" : ""), function(s) {
                                if (-1 !== t) {
                                    ...
                                    if (null == i.error) {
                                        ...
                                        icon: "fa fa-times"
                                    }) : (1 == i.demo && ($(".c_f").toggleClass("c_f-progress-demo", !1), $(".c_f").toggleClass("c_f-lost-demo", !0), $("#game_multiplier").html("x" + parseFloat(i.error).toFixed(2)), $("#game_profit").html("Вы проиграли " + i.bet + '&nbsp;<i class="fad fa-coins"></i>')), 0 == i.demo && ($(".c_f").toggleClass("c_f-progress", !1), $(".c_f").toggleClass("c_f-lost", !0), $("#game_multiplier").html("x" + parseFloat(i.error).toFixed(2)), $("#game_profit").html("Вы проиграли " + i.bet + '&nbsp;<i class="fad fa-coins"></i>')), loseAudio.src = isAudioGame ? "https://cdn.29bet.com/assets/assets/media/lose.mp3" : "", loseAudio.play(), isDemo || sendDrop(a), validateTask(a), _disableDemo = !1, a = null, swap(), updateBalanceN())
                                }
                            })
                        }()
                }))
