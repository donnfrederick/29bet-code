...
<div class="game__wrapper row justify-content-center">
    ...
    <div  class="col-lg-7 col-double">
        <div class="g_sidebar_footer p-0 mb-2 mt-2 justify-content-lg-end">
            <div class="g_sidebar_footer_button tooltip" onclick="$('.md-result-instrution-double').toggleClass('md-show', true);" title="{{ __('Game information')}}">
            ...
            <div class="g_sidebar_footer_button" id="toggleAudio" onclick="setAudioGame(!isAudioGame)">
        ...
        <div class="game__roulette position-relative">
        ...
        {{-- END OF LOSE OUTCOME SECTION --}}
            ...
            <div class="preview__container">
                <div class="background__roulette">
                    <div class="preview__roulette roulette-wheel"></div>
                    <div id="backgroundTimer">
                        <div class="background__timer">
                            <div class="time_bar" style="width: 100%">
                                <div id="timer_init" style="width: 100%;">
                                    <h3 id="timer" class="timer__text text-white" style="position: absolute;"></h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="background__roulette__preview">
                <div class="roulette__latest__preview">
                    <h5>{{ __('Previous Results')}}</h5>
                </div>
                <div id="resultados"></div>
            </div>
            <div class="background__roulette__table" style="display: none;">
                <div class="roulette__result">
                    <table class="result__table">

                        <thead class="result__table__header">
                          <tr>
                            <th class="result__table__header--title">{{ __('Player')}}</th>
                            <th class="result__table__header--title">{{ __('Color')}}</th>
                            <th class="result__table__header--title">{{ __('Valor')}}</th>
                          </tr>
                        </thead>

                        <tbody class="result__table__body">
                          <tr class="result__table__body__content">
                            <td class="table__body__content__result">James</td>
                            <td class="table__body__content__result">Matman</td>
                            <td class="table__body__content__result">R$: 10,00</td>
                          </tr>
                          <tr class="result__table__body__content">
                            <td class="table__body__content__result">James</td>
                            <td class="table__body__content__result">Matman</td>
            ...
            {{-- <div class="col-xs-12">
                <div class="bet_profit">
                    {{__('Выигрыш:')}} <span id="bet_profit"></span> &nbsp;<i class="fad fa-coins"></i>
                    <div class="hidden-xs mt5">
                        {{__('Цвет:')}} <span id="w_color" class="bet_profit-error">{{__('Не выбран')}}</span>
                    </div>
                </div>
            </div> --}}
            <div class="wheel__gain">
                <h5 class="wheel__gain__amount"><span id="ttxt"></span>: R$ <span id="bet_profit">0.00</span></h5>
                <p class="wheel__gain__selected">{{ __('Color')}}: <span id="w_color" class="bet_profit-error"></span></p>
            </div>
<style>
.wheel__select--red.w_active {
    border: 1px solid #ffffff;
    box-shadow: none;
}
.wheel__select--white.w_active {
    border: 1px solid #fa2f5c;
    box-shadow: none;
}
.wheel__select--black.w_active {
    border: 1px solid #ffffff;
    box-shadow: none;
}
</style>
            <div class="mt5 wheel--linhabtn mb-2">
                <div class="row m0">
                    <div class="col">
                        <div data-x="2" class="w_color_btn w_color_btn-red mt5 wheel__select--red" data-wheel-color="red" onclick="newWheel.pickColor('red')">
                            x2
                        </div>
                    </div>
                    <div class="col">
                        <div data-x="14"  class="w_color_btn w_color_btn-white mt5 wheel__select--white" data-wheel-color="white" onclick="newWheel.pickColor('white')">
                            x14
                        </div>
                    </div>
                    <div class="col">
                        <div data-x="2" class="w_color_btn w_color_btn-black mt5 wheel__select--black" data-wheel-color="black" onclick="newWheel.pickColor('black')">
                            x2
                        </div>
                    </div>
                </div>
        ...
        <div>
                <div class="general__control d-flex m-0">
                    ...
                    <div class="general__control__box double__bet my-2 my-lg-3">
                    ...
                    <button class="g_s general__control__box--play double__play my-2 my-lg-3" id="play" disabled><span id="bet_btn">{{ __("Play")}}</span></button>

                </div>


                {{-- <div class="g_s g_btn wheel__apost__wheel mt-3" id="play">{{__('Играть')}}</div> --}}

        </div>
    </div>
    <div class="col-lg-4">
        <div class="players pc crash__players" style="max-height: 615px;">
            <div class="d-flex justify-content-between align-items-center mb-2 r-head">
                ...
                <div class="crash__player__title--multiplier">Cor</div>
...
@section('js')
<span style="display: none;" id="speed" data-game-speed="{{ $speed }}"></span>
<span style="display: none;" id="waiting_time" data-game-waiting="{{ $waiting }}"></span>
...
$(document).ready(function() {
    $('#ttxt').text(gTTxt(0));
    $('#w_color').text(gTTxt(1));
});
const tcor = ["{{ __('Red') }}", "{{ __('Black') }}", "{{ __('White') }}"];
</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/3.0.4/socket.io.js"></script>
{{-- <script src="https://cdn.29bet.com/assets/js/double/functions.js"></script>
<script src="https://cdn.29bet.com/assets/js/double/script.js"></script> --}}
<script src="{{ asset('js/double/functions.js') }}"></script>
<script src="{{ asset('js/double/script.js') }}"></script>
