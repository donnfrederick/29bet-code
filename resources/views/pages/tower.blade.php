@extends('welcome')
@section('css')
    <link rel="stylesheet" href="https://cdn.29bet.com/assets/css/games/tower.css">
    <style>
        #playCrash:disabled {
            cursor: not-allowed;
...
<div class="game__wrapper row justify-content-center">
    <div class="col-lg-7 col-12 col-tower">
        <div class="g_sidebar_footer p-0 mb-1 mt-1 mb-sm-3 mb-lg-3  0 justify-content-lg-end">
                <div class="g_sidebar_footer_button tooltip" onclick="$('.md-result-instrution-tower').toggleClass('md-show', true);" title="{{ __('Game information')}}">
                ...
                <div class="g_sidebar_footer_button" id="tower_music" data-music="on" onclick="setAudioGame(!isAudioGame)">
        ...
        <div class="games__tower position-relative" id="w_container" class="" {{-- style="background-image: url('{{ asset('img/all/pages/games/background-tower.png') }}')" --}} >
        ...
        {{-- END OF LOSE OUTCOME SECTION --}}
            ...
            {{-- <div class="outcome-window-demo outcome-window_won-demo outcome-window_centered">
                <div class="outcome-window__coeff-demo outcome-window_won__coeff-demo">x0</div>
                <div class="outcome-window__text outcome-window_won__text">Você ganhou bbbbbbbbbbbbbbbbbb
            ...
            <div class="games__tower__content">
                <div class="towerd ">
                    <div class="tower_multipliers games__tower__content__multiplier">
                        @for($i = 0; $i < 10; $i++)
                            <div class="games__tower__content__score" data-row-id="{{$i}}"></div>
                        @endfor
                    </div>
                </div>

                <div class="towerd games__tower__content__boxes">
                    <div class="tower_grid">
                        @php
                            $same = array();
                        ...
                        @for($i = 0; $i < 5 * 10; $i++)
                            ...
                            <div data-r="{{$i % 10}}" data-grid-in-row-id="{{sizeof($same[$i % 10]) - 1}}" data-grid-id="{{$i}}" class="games__tower__content__box mine_disabled tower_select"><div></div></div>
                        @endfor
                    </div>
                </div>
            </div>
        ...
        <div class="mt-3 control2">
            {{-- <div class="tower__value">
                <div class="w-100 position-relative">
                    <script>var __profit = function() { }; </script>
                    <strong class="tower__value__rs">R$</strong>
                    <input id="bet" data-number-input="true" value="<?= Auth::guest() ? '100.00' : '1' ?>" type="text" class="b_input tower__value__amount">
                    <div class="b_input_btns tower__value__buttons">
                ...
                <div class="w-100">
                    <div class="b_input_bottom tower__value__quantity" style="display: inline-block">
            ...
            <div class="general__control d-flex m-0">
                ...
                <div class="general__control__box double__bet my-sm-3 my-lg-3" >
                ...
                <button class="g_s general__control__box--play double__play my-2 my-sm-3 my-lg-3" id="play" onclick="tower()"><span id="bet_btn">{{ __('Play')}}</span></button>

            </div>
            <div class="col-xs-12 mb10 my-3">
                <div class="bombs_container bombs__container__tower tower_container">
                    <div data-bomb="1" class="bombs__container__tower__item bc_active">1</div>
                    <div data-bomb="2" class="bombs__container__tower__item">2</div>
                    <div data-bomb="3" class="bombs__container__tower__item">3</div>
                    <div data-bomb="4" class="bombs__container__tower__item">4</div>
                </div>
            </div>

            {{-- <div class="col-xs-12 col-sm-12">
                <div class="g_s g_btn tower__play" onclick="tower()" id="play"><span id="bet_btn">Jogar</span></div>
            </div> --}}
