...
<div class="game__wrapper row justify-content-center">
    ...
    <div class="col-lg-7">
        <div class="g_sidebar_footer p-0 mb-2 mt-2 mb-sm-3 mb-lg-3 justify-content-lg-end">
                <div class="g_sidebar_footer_button tooltip" onclick="$('.md-result-instrution-hilo').toggleClass('md-show', true);" title="{{ __('Game information')}}">
                ...
                <div class="g_sidebar_footer_button" id="hilo_music" data-music="on" onclick="setAudioGame(!isAudioGame)">
        ...
        <div class="congrats">
            ...
            <div class="el text animated d-none " data-in="zoomOutIn" data-out="zoomOutLeft"></div>
            <div class="el text animated d-none" data-in="zoomOutIn" data-out="zoomOutLeft">
                {{--  --}}
                <strong class="ri"></strong>
                <strong id="cf_status_text"></strong>
        ...
        <div class="YOU_LOSE">
            ...
            <div class="el text_LOSE animated d-none" data-in="zoomOutIn"
                ...
                <h1 class="ribbode hilo__status__text">
                    <strong class="ri" id="cf_status_text"></strong>
                </h1>
        </div>
        {{-- END OF LOSE OUTCOME SECTION --}}


            {{-- <div class="cf_status hilo__status outcome-window_centered shadow-blue" style="top: 50%!important;">
                <div class="game__win__images text-center">
                    <img class="game__win__images--tropheu hilo__play--win" src="https://cdn.29bet.com/assets/img/tropheu.webp" alt="https://cdn.29bet.com/assets/img/tropheu.webp">
                    <img class="game__win__images--tropheu hilo__play--lose" src="https://cdn.29bet.com/assets/img/tropheu-broken.webp" alt="https://cdn.29bet.com/assets/img/tropheu-broken.webp">
            ...
            <div class="d-flex justify-content-center gap-2">
                <div class="{{-- cf_s --}} hilo__tip w-100 position-relative">
                    <div class="hilo__tip__items w-100 justify-content-center">
                        <div>
                            <div class="d-md-flex gap-2 justify-content-around">
                                <div class="hilo__tip__info w-100 my-2">
                                    <img class="hilo__tip__info--img" src="https://cdn.29bet.com/assets/img/all/pages/games/a.svg" alt="https://cdn.29bet.com/assets/img/all/pages/games/a.svg">
                                    <p class="mt-2">{{ __('ACE BEING THE LOWEST')}}</p>
                                </div>
                                <div class="hilo__tip__info w-100 my-2">
                                    <img class="hilo__tip__info--img" src="https://cdn.29bet.com/assets/img/all/pages/games/k.svg" alt="">
                                    <p class="mt-2">{{ __('THE KING BE THE GREATEST')}}</p>
                                </div>
                            </div>
                            {{-- <p>ACE SENDO O MAIS BAIXO O REI SEJA O MAIOR</p>      --}}
                        </div>
                    </div>
                </div>


                <div class="hilo__card w-1f00">
                    <div class="hilo_card position-relative">
                        <div class="hilo-card-value"></div>
                        <i id="card_icon"></i>
                        <div class="hilo-replace hilo__repeate" onclick="replace()">
                            <p>{{ __('Jump')}}</p>
                ...
                <div class="position-relative hilo__divisions w-100">
                    <div class=" {{-- cf_s cf_s_c  --}} hilo__coefficient">
                        <div>
                            <span><span>x</span><span id="mul">0</span><span>.</span><span id="mul_m">0</span></span>
                            <p>{{ __('COEFICIENTE')}}</p>
                        </div>
                    </div>

                    <div class="{{-- cf_s --}} hilo__kart">
                        <span>
        ...
        <div>
            <div class="w-100  mb-1 md-sm-2 mb-lg-2">
                <div class="cf_history hilo__old__cards overflow-hidden"></div>
            </div>
            <div class="w-100 my-1 my-sm-3 my-lg-3">
                <div class="d-flex align-items-center gap-2">
                    <div class="hilo-select w-100 hilo__selected hilo__low hilo_disabled d-flex justify-content-between align-items-center" onclick="flip('lower')">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="25px" height="35px" viewBox="0 0 24 24" stroke-width="5.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25L12 21m0 0l-3.75-3.75M12 21V3" />
                            </svg>
                        </span>
                        <div class="text-center">
                            <div class="hilo-chance"><span id="chance-l_ma">0</span>.<span id="chance-l_mi">0</span>%</div>
                            <div class="hilo-chance-desc" id="lower">{{ __('Below or equal')}}</div>
                        </div>
                        <div class="coefficient__text"><span id="mul-l_ma">0</span>.<span id="mul-l_mi">0</span>x</div>
                    </div>
                    <div class="hilo-select w-100 hilo__selected hilo__high hilo_disabled d-flex justify-content-between align-items-center" onclick="flip('higher')">
                        ...
                        <div class="text-center">
                            ...
                            <div class="hilo-chance-desc" id="higher">{{ __('Above or equal')}}</div>
                        </div>
                        <div class="coefficient__text"><span id="mul-h_ma">0</span>.<span id="mul-h_mi">0</span>x</div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-100">
                <div class="general__control d-flex m-0">
                            ...
                            <label class="general__control__box__label" for="bet">
                                <div class="general__control__box__label__bet">
                                    <div class="general__control__box__label__bet__values d-flex align-items-center gap-1">
                                        <span class="general__control__box__label__bet__values--rs mt-1"><img width="24" src="https://cdn.29bet.com/assets/img/rs.svg" alt=""> </span>
                    ...
                    <button class="g_s general__control__box--play double__play mt-1 mb-2 my-sm-3 my-lg-3" id="play"><span id="bet_btn">{{ __('Play')}}</span></button>
                </div>
    ...
    <div class="col-lg-4">
        <div class="players pc crash__players" style="max-height: 550px;">
